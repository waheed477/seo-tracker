    ...
    <div className="p-6 lg:p-8 max-w-3xl fade-in">
      ...
      <div className="flex items-center justify-between mb-7">
        <div>
          ...
          <p className="text-sm text-sage/60 mt-0.5">Manage domains in this workspace</p>
        </div>
      ...
      {fetching ? (
        ...
        <div className="space-y-2">
          {sites.map(site => (
            <div
              key={site._id}
              className="flex items-center justify-between px-5 py-4 rounded-xl border border-white/[0.06] bg-white/[0.02]"
            >
              <div className="flex items-center gap-4">
                <div className="w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.08] flex items-center justify-center flex-shrink-0">
                  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5"
                    className="w-4 h-4 text-sage/50">
