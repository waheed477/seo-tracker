...
export default function CookiePolicy() {
  return (
    <LegalLayout title="Cookie Policy" lastUpdated="July 2025">
      ...
      <h2 className="font-heading text-[var(--color-text-primary)] mt-8 mb-3 text-lg font-semibold">What we use</h2>

      <div className="overflow-hidden rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)]">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[var(--color-border)]">
              <th className="font-heading text-[var(--color-text-primary)] px-5 py-3 text-left text-xs font-semibold tracking-wider uppercase">
                Type
              </th>
              <th className="font-heading text-[var(--color-text-tertiary)] px-5 py-3 text-left text-xs font-semibold tracking-wider uppercase">
                Purpose
              </th>
              <th className="font-heading text-[var(--color-text-tertiary)] px-5 py-3 text-left text-xs font-semibold tracking-wider uppercase">
                Persistence
          ...
          <tbody className="divide-y divide-[var(--color-border)]">
            <tr>
              <td className="text-[var(--color-text-primary)] px-5 py-3">Auth token (JWT)</td>
              <td className="text-[var(--color-text-tertiary)] px-5 py-3">
                Identifies your session to the API. Stored in browser memory (Zustand store), not a cookie.
              </td>
              <td className="text-[var(--color-text-tertiary)] px-5 py-3">Session only — cleared on tab close or page refresh</td>
            </tr>
          </tbody>
        </table>
      </div>

      <h2 className="font-heading text-[var(--color-text-primary)] mt-8 mb-3 text-lg font-semibold">What we don&apos;t use</h2>
      ...
      <h2 className="font-heading text-[var(--color-text-primary)] mt-8 mb-3 text-lg font-semibold">If we add analytics later</h2>
      <p>
      ...
      <h2 className="font-heading text-[var(--color-text-primary)] mt-8 mb-3 text-lg font-semibold">Google Fonts</h2>
      <p>
      ...
      <h2 className="font-heading text-[var(--color-text-primary)] mt-8 mb-3 text-lg font-semibold">Contact</h2>
      <p>
        Questions?{' '}
