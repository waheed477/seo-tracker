...
export default function ContactPage() {
  return (
    <LegalLayout title="Contact Us">
      ...
      <h2 className="font-heading text-[var(--color-text-primary)] mt-8 mb-3 text-lg font-semibold">Support</h2>
      ...
      <div className="mt-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5">
        <a
          ...
          className="text-[var(--color-accent)] hover:text-[var(--color-accent-hover)] group flex items-center gap-3 transition-colors"
        >
          <span className="bg-[var(--color-accent)]/15 border-[var(--color-accent)]/20 flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg border">
            <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-[var(--color-accent)] h-4 w-4">
          ...
          <div>
            ...
            <p className="text-[var(--color-text-tertiary)] mt-0.5 text-xs">Account issues, feature requests, general questions</p>
          </div>
        </a>
      </div>

      <h2 className="font-heading text-[var(--color-text-primary)] mt-8 mb-3 text-lg font-semibold">Security</h2>
      ...
      <h2 className="font-heading text-[var(--color-text-primary)] mt-8 mb-3 text-lg font-semibold">Data deletion requests</h2>
      <p>
      ...
      <h2 className="font-heading text-[var(--color-text-primary)] mt-8 mb-3 text-lg font-semibold">Open source</h2>
      <p>
