      ...
      return (
        <div className="fade-in max-w-4xl p-6 lg:p-8">
          <div className="rounded-xl border border-red-800/40 bg-red-900/20 p-8 text-center">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl border border-red-800/40 bg-red-900/40">
              <svg
                viewBox="0 0 16 16"
                fill="none"
                stroke="currentColor"
            ...
            {this.state.error?.message && (
              <p className="mx-auto mb-4 max-w-lg font-mono text-xs text-red-400/60">{this.state.error.message}</p>
            )}
            <button
